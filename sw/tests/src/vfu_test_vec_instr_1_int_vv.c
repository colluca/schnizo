...
int main() {
    if (snrt_global_core_idx() == 0) {
        ...
        for (int i = 0; i < N; i++)
            if (zi[i] != xi[i] + yi[i]) {
                printf("vle/vse/vadd error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if (zi[i] != (xi[i] < yi[i] ? xi[i] : yi[i])) {
                printf("vmin error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if ((uint64_t)zi[i] != (xu[i] < yu[i] ? xu[i] : yu[i])) {
                printf("vminu error at %d\n", i);
                errors++;
            }
        ...
        for (int i = 0; i < N; i++)
            if ((uint64_t)zi[i] != (xu[i] > yu[i] ? xu[i] : yu[i])) {
                printf("vmaxu error at %d\n", i);
                errors++;
            }

        SECTION_END(
            "integer vv arithmetic "
            "(vadd/vsub/vand/vor/vxor/vmin/vminu/vmax/vmaxu)");
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if ((uint64_t)zi[i] != (xu[i] >> yu[i])) {
                printf("vsrl error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if (zi[i] != (xi_neg[i] >> yi[i])) {
                printf("vsra error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if (zi[i] != (int64_t)xi32[i] * (int64_t)yi32[i]) {
                printf("vwmul error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if ((uint64_t)zi[i] != (uint64_t)xu32[i] * (uint64_t)yu32[i]) {
                printf("vwmulu error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if (zi[i] != (int64_t)xi32[i] * (int64_t)yu32[i]) {
                printf("vwmulsu error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if (zi[i] != ai64[i] + (int64_t)xi32[i] * (int64_t)yi32[i]) {
                printf("vwmacc error at %d\n", i);
                errors++;
            }
        ...
        for (int i = 0; i < N; i++)
            if ((uint64_t)zi[i] !=
                (uint64_t)ai64[i] + (uint64_t)xu32[i] * (uint64_t)yu32[i]) {
                printf("vwmaccu error at %d\n", i);
                errors++;
            }
        ...
        asm volatile("vse64.v v8, (%0)" ::"r"(zi));
        for (int i = 0; i < N; i++)
            if (zi[i] != ai64[i] + (int64_t)xi32[i] * (int64_t)yu32[i]) {
                printf("vwmaccsu error at %d\n", i);
                errors++;
            }
