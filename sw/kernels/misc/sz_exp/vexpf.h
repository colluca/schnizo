...
#define IMPL_NAIVE 0
#define IMPL_NAIVE_TCDM 1
#define IMPL_BASELINE 2
#define IMPL_BASELINE_TCDM 3
#define IMPL_FREP 4
#define IMPL_FREP_TCDM 5
#define IMPL_FREP_UNROLLED 6

#ifndef IMPL
#define IMPL IMPL_NAIVE_TCDM
#endif

#if IMPL == IMPL_NAIVE
#define FUNC_PTR vexpf_naive
#elif IMPL == IMPL_NAIVE_TCDM
#define FUNC_PTR vexpf_naive_tcdm
#elif IMPL == IMPL_BASELINE
#define FUNC_PTR vexpf_baseline
#elif IMPL == IMPL_BASELINE_TCDM
#define FUNC_PTR vexpf_baseline_tcdm
#elif IMPL == IMPL_FREP
#define FUNC_PTR vexpf_frep
#elif IMPL == IMPL_FREP_TCDM
#define FUNC_PTR vexpf_frep_tcdm
#elif IMPL == IMPL_FREP_UNROLLED
#define FUNC_PTR vexpf_frep_unrolled
#endif
...
#include "vexpf_baseline_tcdm.h"
#include "vexpf_frep.h"
#include "vexpf_frep_tcdm.h"
#include "vexpf_frep_unrolled.h"
#include "vexpf_naive.h"
#include "vexpf_naive_tcdm.h"
