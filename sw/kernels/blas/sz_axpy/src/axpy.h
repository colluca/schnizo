...
static inline void axpy_post_increment_schnizo(uint32_t n, double a, double *x,
                                               double *y, double *z) {
    int core_idx = snrt_cluster_core_idx();
    int num_cores = snrt_cluster_compute_core_num();
    int frac = n / num_cores;
...
static inline void axpy_unrolled_schnizo(uint32_t n, double a, double *x,
                                         double *y, double *z) {
    int core_idx = snrt_cluster_core_idx();
    int num_cores = snrt_cluster_compute_core_num();
...
static inline void axpy_peeled_10x_schnizo(uint32_t n, double a, double *x,
                                           double *y, double *z) {
    int core_idx = snrt_cluster_core_idx();
    int num_cores = snrt_cluster_compute_core_num();
    ...
    asm volatile(
        ...
        : "ft0", "ft1", "ft2", "ft3", "ft4", "ft5", "ft6", "ft7", "ft8", "ft9",
          "ft10", "ft11", "fa2", "fa3", "fa4", "fa5", "fa6", "fa7", "fs0",
          "fs1", "fs2", "fs3", "fs4", "fs5", "fs6", "fs7", "fs8", "fs9", "fs10",
          "fs11", "memory");
    snrt_mcycle();
}

// 4 times unrolled and peeled
static inline void axpy_peeled_schnizo(uint32_t n, double a, double *x,
                                       double *y, double *z) {
    int core_idx = snrt_cluster_core_idx();
    int num_cores = snrt_cluster_compute_core_num();
