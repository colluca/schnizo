        ...
        for (; i + 3 < (int)M; i += 4) {
            ...
            if (beta) {
                ...
                asm volatile("vle64.v v8,  (%0)"
                             :
                             : "r"(C + (i + 1) * ldc + j_tile));
                asm volatile("vle64.v v16, (%0)"
                             :
                             : "r"(C + (i + 2) * ldc + j_tile));
                asm volatile("vle64.v v28, (%0)"
                             :
                             : "r"(C + (i + 3) * ldc + j_tile));
                uint32_t n_frep = K - 1;
                asm volatile(
            ...
            asm volatile("vse64.v v8,  (%0)"
                         ...
                         : "r"(C + (i + 1) * ldc + j_tile)
                         : "memory");
            asm volatile("vse64.v v16, (%0)"
                         :
                         : "r"(C + (i + 2) * ldc + j_tile)
                         : "memory");
            asm volatile("vse64.v v28, (%0)"
                         :
                         : "r"(C + (i + 3) * ldc + j_tile)
                         : "memory");
        }
        ...
        for (; i + 5 < (int)M; i += 6) {
            ...
            if (beta) {
                ...
                asm volatile("vle64.v v28, (%0)"
                             :
                             : "r"(C + (i + 3) * ldc + j_tile));
                asm volatile("vle64.v v4,  (%0)"
                             :
                             : "r"(C + (i + 4) * ldc + j_tile));
                asm volatile("vle64.v v12, (%0)"
                             :
                             : "r"(C + (i + 5) * ldc + j_tile));
                uint32_t n_frep = K - 1;
                asm volatile(
            ...
            asm volatile("vse64.v v28, (%0)"
                         ...
                         : "r"(C + (i + 3) * ldc + j_tile)
                         : "memory");
            asm volatile("vse64.v v4,  (%0)"
                         :
                         : "r"(C + (i + 4) * ldc + j_tile)
                         : "memory");
            asm volatile("vse64.v v12, (%0)"
                         :
                         : "r"(C + (i + 5) * ldc + j_tile)
                         : "memory");
        }
        ...
        for (; i + 7 < (int)M; i += 8) {
            ...
            if (beta) {
                ...
                asm volatile("vle64.v v12, (%0)"
                             :
                             : "r"(C + (i + 5) * ldc + j_tile));
                asm volatile("vle64.v v20, (%0)"
                             :
                             : "r"(C + (i + 6) * ldc + j_tile));
                asm volatile("vle64.v v22, (%0)"
                             :
                             : "r"(C + (i + 7) * ldc + j_tile));
                uint32_t n_frep = K - 1;
                asm volatile(
            ...
            asm volatile("vse64.v v12, (%0)"
                         ...
                         : "r"(C + (i + 5) * ldc + j_tile)
                         : "memory");
            asm volatile("vse64.v v20, (%0)"
                         :
                         : "r"(C + (i + 6) * ldc + j_tile)
                         : "memory");
            asm volatile("vse64.v v22, (%0)"
                         :
                         : "r"(C + (i + 7) * ldc + j_tile)
                         : "memory");
        }
