...
import sys
import torch
from datagen import SoftmaxDataGen
...
class SoftmaxVerifier(Verifier):
    ...
    def get_expected_results(self):
        ...
        ifmap = torch.from_numpy(ifmap.reshape(self.batch_size, self.seq_len, self.input_samples))
        return SoftmaxDataGen().golden_model(ifmap, self.reduce_dim).detach().numpy().flatten()
