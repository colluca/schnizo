...
class ReluDataGen(du.DataGen):
    ...
    def golden_model(self, ifmap):
        return torch.nn.functional.relu(ifmap)
    ...
    def emit_header(self, **kwargs):
        ...
        header += [du.format_struct_definition('relu_layer_t', 'layer', layer_cfg)]
