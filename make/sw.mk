...
SN_APPS += $(SN_ROOT)/sw/kernels/dnn/rms_norm
SN_APPS += $(SN_ROOT)/sw/kernels/dnn/eltwise
SN_APPS += $(SN_ROOT)/sw/kernels/dnn/relu
SN_APPS += $(SN_ROOT)/sw/kernels/dnn/silu
SN_APPS += $(SN_ROOT)/sw/kernels/dnn/interpolate
SN_APPS += $(SN_ROOT)/sw/kernels/dnn/nms
...
SN_APPS += $(SN_ROOT)/sw/kernels/blas/sz_axpy
