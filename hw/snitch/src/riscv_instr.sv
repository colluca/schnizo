...
package riscv_instr;
  ...
  localparam logic [31:0] DMSRC              = 32'b0000000??????????011000000101011;
  localparam logic [31:0] DMDST              = 32'b0000001??????????011000000101011;
  localparam logic [31:0] DMCPYI             = 32'b0000010??????????011?????0101011;
  localparam logic [31:0] DMCPY              = 32'b0000011??????????011?????0101011;
  localparam logic [31:0] DMSTATI            = 32'b0000100?????00000011?????0101011;
  localparam logic [31:0] DMSTAT             = 32'b0000101?????00000011?????0101011;
  localparam logic [31:0] DMSTR              = 32'b0000110??????????011000000101011;
  localparam logic [31:0] DMREP              = 32'b000011100000?????011000000101011;
  localparam logic [31:0] DMUSER             = 32'b0001000??????????011000000101011;
  localparam logic [31:0] DMINIT             = 32'b0001001??????????011?????0101011;
