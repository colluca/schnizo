...
package riscv_instr;
  ...
  localparam logic [31:0] VLXEI8_V           = 32'b???011???????????000?????0000111;
  localparam logic [31:0] VLXEI16_V          = 32'b???011???????????101?????0000111;
  localparam logic [31:0] VLXEI32_V          = 32'b???011???????????110?????0000111;
  localparam logic [31:0] VLXEI64_V          = 32'b???011???????????111?????0000111;
  localparam logic [31:0] VLXEI128_V         = 32'b???111???????????000?????0000111;
  localparam logic [31:0] VLXEI256_V         = 32'b???111???????????101?????0000111;
  localparam logic [31:0] VLXEI512_V         = 32'b???111???????????110?????0000111;
  localparam logic [31:0] VLXEI1024_V        = 32'b???111???????????111?????0000111;
  localparam logic [31:0] VSXEI8_V           = 32'b???011???????????000?????0100111;
  localparam logic [31:0] VSXEI16_V          = 32'b???011???????????101?????0100111;
  localparam logic [31:0] VSXEI32_V          = 32'b???011???????????110?????0100111;
  localparam logic [31:0] VSXEI64_V          = 32'b???011???????????111?????0100111;
  localparam logic [31:0] VSXEI128_V         = 32'b???111???????????000?????0100111;
  localparam logic [31:0] VSXEI256_V         = 32'b???111???????????101?????0100111;
  localparam logic [31:0] VSXEI512_V         = 32'b???111???????????110?????0100111;
  localparam logic [31:0] VSXEI1024_V        = 32'b???111???????????111?????0100111;
  ...
  localparam logic [31:0] VFREDSUM_VS        = 32'b000001???????????001?????1010111;
  ...
  localparam logic [31:0] VFRSQRTE7_V        = 32'b010011??????00100001?????1010111;
  localparam logic [31:0] VFRECE7_V          = 32'b010011??????00101001?????1010111;
  localparam logic [31:0] VFCLASS_V          = 32'b010011??????10000001?????1010111;
  localparam logic [31:0] VFWADD_VV          = 32'b110000???????????001?????1010111;
  localparam logic [31:0] VFWREDSUM_VS       = 32'b110001???????????001?????1010111;
  ...
  localparam logic [31:0] VFDOT_VV           = 32'b111001???????????001?????1010111;
  ...
  localparam logic [31:0] VMADC_VXM          = 32'b010001???????????100?????1010111;
  localparam logic [31:0] VMSBC_VXM          = 32'b010011???????????100?????1010111;
  ...
  localparam logic [31:0] VQMACCU_VX         = 32'b111100???????????100?????1010111;
  localparam logic [31:0] VQMACC_VX          = 32'b111101???????????100?????1010111;
  localparam logic [31:0] VQMACCUS_VX        = 32'b111110???????????100?????1010111;
  localparam logic [31:0] VQMACCSU_VX        = 32'b111111???????????100?????1010111;
  ...
  localparam logic [31:0] VMADC_VVM          = 32'b010001???????????000?????1010111;
  localparam logic [31:0] VMSBC_VVM          = 32'b010011???????????000?????1010111;
  ...
  localparam logic [31:0] VDOTU_VV           = 32'b111000???????????000?????1010111;
  localparam logic [31:0] VDOT_VV            = 32'b111001???????????000?????1010111;
  localparam logic [31:0] VQMACCU_VV         = 32'b111100???????????000?????1010111;
  localparam logic [31:0] VQMACC_VV          = 32'b111101???????????000?????1010111;
  localparam logic [31:0] VQMACCSU_VV        = 32'b111111???????????000?????1010111;
  ...
  localparam logic [31:0] VMADC_VIM          = 32'b010001???????????011?????1010111;
  ...
  localparam logic [31:0] VMANDNOT_MM        = 32'b011000???????????010?????1010111;
  ...
  localparam logic [31:0] VMORNOT_MM         = 32'b011100???????????010?????1010111;
  ...
  localparam logic [31:0] VPOPC_M            = 32'b010000??????10000010?????1010111;
