...
module schnizo_fu_stage_synth #(
  ...
  input  logic               [NofVFU+NofVLSU-1:0]                 vfu_disp_reqs_valid_i,
  output logic               [NofVFU+NofVLSU-1:0]                 vfu_disp_reqs_ready_o,
  output schnizo_synth_pkg::disp_rsp_t [NofVFU+NofVLSU-1:0]       vfu_disp_rsp_o,
  output logic                                                    vfu_loop_finish_o,
  output logic               [NofVFU+NofVLSU-1:0]                 vfu_rs_full_o,
  output logic [schnizo_synth_pkg::FLEN-1:0]                      vfu_wb_result_o,
  output schnizo_pkg::instr_tag_t                                 vfu_wb_result_tag_o,
  output logic                                                    vfu_wb_result_valid_o,
  input  logic                                                    vfu_wb_result_ready_i,
  output schnizo_synth_pkg::tcdm_req_t [NofVLSU*((NumSpatzFPUs>NumSpatzIPUs)?NumSpatzFPUs:NumSpatzIPUs)-1:0] vfu_tcdm_req_o,
  input  schnizo_synth_pkg::tcdm_rsp_t [NofVLSU*((NumSpatzFPUs>NumSpatzIPUs)?NumSpatzFPUs:NumSpatzIPUs)-1:0] vfu_tcdm_rsp_i,
