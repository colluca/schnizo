...
module schnizo_res_stat_synth #(
  ...
  output schnizo_synth_pkg::operand_req_t [NofOpPorts-1:0][NofOperands-1:0] op_reqs_o,
  ...
  input  schnizo_synth_pkg::operand_t     [NofOpPorts-1:0][NofOperands-1:0] op_rsps_i,
