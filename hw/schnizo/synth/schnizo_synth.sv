...
module schnizo_synth #(
	...
	parameter int unsigned AluLsuNofRsis  = 4,
	parameter int unsigned AluLsuNofRsrs = 4,
	...
	output schnizo_synth_pkg::data_req_t [NofLsus+NofAluLsus-1:0]   data_req_o,
	input  schnizo_synth_pkg::data_rsp_t [NofLsus+NofAluLsus-1:0]   data_rsp_i,
