...
// Description: The Schnizo write back logic. It handles all write back request from all FUs.
...
module schnizo_writeback import schnizo_pkg::*; #(
  ...
  assign retired_load_o         = (lsu_gpr_valid & lsu_gpr_ready) || (lsu_fpr_valid & lsu_fpr_ready);
