...
module schnizo_multiplier import schnizo_pkg::*; #(
  ...
  // Outstanding instructions counter
  logic [1:0] insn_cnt;
  counter #(
    .WIDTH(2)
  ) i_insn_counter (
    ...
    .rst_ni,
    .clear_i(1'b0),
    .en_i((valid_i && ready_o) != (valid_o && ready_i)),
    .load_i(1'b0),
    .down_i(valid_o && ready_i),
    .d_i('0),
    .q_o(insn_cnt),
    .overflow_o()
  );
  assign busy_o = valid_o || (insn_cnt > 0);
