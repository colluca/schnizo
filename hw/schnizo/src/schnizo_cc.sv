...
module schnizo_cc #(
  ...
  parameter int unsigned NumAluLsuRsis        = 1,
  parameter int unsigned NumAluLsuRsrs        = 1,
  parameter int unsigned NumFpuRss            = 4,
  parameter int unsigned NumAluConstants      = 4,
  parameter int unsigned NumLsuConstants      = 4,
  parameter int unsigned NumAluLsuConstants   = 4,
  parameter int unsigned NumFpuConstants      = 4,
  ...
  parameter bit          En2ndAluLsuResPort   = 1'b0,
  ...
  schnizo #(
    ...
    .AluNofRss             (NumAluRss),
    .LsuNofRss             (NumLsuRss),
    .AluLsuNofRsis         (NumAluLsuRsis),
    .AluLsuNofRsrs         (NumAluLsuRsrs),
    .FpuNofRss             (NumFpuRss),
    .AluNofConstants       (NumAluConstants),
    .LsuNofConstants       (NumLsuConstants),
    .AluLsuNofConstants    (NumAluLsuConstants),
    .FpuNofConstants       (NumFpuConstants),
