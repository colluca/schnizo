...
module schnizo_scoreboard import schnizo_pkg::*; #(
  ...
  assign op_a_has_raw = instr_dec_i.rs1_is_fp ? sbf_q[instr_dec_i.rs1] : sbi_q[instr_dec_i.rs1];
  assign op_b_has_raw = instr_dec_i.rs2_is_fp ? sbf_q[instr_dec_i.rs2] : sbi_q[instr_dec_i.rs2];
