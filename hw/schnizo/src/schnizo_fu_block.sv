...
// Description: The module hosting a Reservation Station and selecting between regular and
...
module schnizo_fu_block import schnizo_pkg::*; #(
  ...
  // ---------------------------
  // Local connection signals. "rs" for reservation station, "si" for single issue / regular
