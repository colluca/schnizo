...
module schnova_cc #(
  ...
  parameter int unsigned NumAluBufEntries   = 32,
  parameter int unsigned NumLsuBufEntries   = 32,
  parameter int unsigned NumFpuBufEntries   = 32,
  ...
  schnova #(
    ...
    .NofLsus               (NumLsus),
    .NofFpus               (NumFpus),
    .NofAluBufEntries      (NumAluBufEntries),
    .NofLsuBufEntries      (NumLsuBufEntries),
    .NofFpuBufEntries      (NumFpuBufEntries),
    .AluNofRss             (NumAluRss),
    .LsuNofRss             (NumLsuRss),
    .FpuNofRss             (NumFpuRss),
